      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-singular-learning-theory",
          title: 'Singular Learning Theory',
          description: "I am not satisfied with any of the material on SLT online, so I decided to write my own. I have made an attempt to make it very comprehensive and very self contained.",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://drive.google.com/file/d/1octhI9baYSghTEv35dv09jqqzuoTku3W/view?usp=share_link", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%67%61%73%74%79%61.%61%67%72@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/agastyaagrawal", "_blank");
        },
      },{
      id: 'light-theme',
